...
export default function ScrollToTop() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[99] items-center justify-center">
      {/* <a
      ...
      <div className="group relative">
        ...
        <span
          className="absolute -top-14 left-[50%] z-20 w-25 
  origin-left -translate-x-[50%] -translate-y-[50%] scale-0 rounded-lg border 
  border-gray-300 bg-white py-2 text-center text-sm font-bold
